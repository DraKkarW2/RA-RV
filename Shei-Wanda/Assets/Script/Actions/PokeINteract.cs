...
namespace Oculus.Interaction
{
    public class InteractableColorVisual : MonoBehaviour
    {
        ...
        [SerializeField]
        private UnityEvent _onSelectAction; // Event triggered when the object is grabbed

        public UnityEvent OnSelectAction => _onSelectAction;
        ...
        protected virtual void UpdateVisual()
        {
            ...
            if (target != _target)
            {
                ...
                if (target == _selectColorState)
                {
                    Debug.Log("Sélection détectée -> Exécution de l'action assignée.");
